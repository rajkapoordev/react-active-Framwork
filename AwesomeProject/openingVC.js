        ...
        return (
            <View style={{alignItems: 'center'}}>
                ...
                <Text style={styleText.content1}>bloggers closest.Yep, it's cool.</Text>
                    <TouchableHighlight onPress={this.onButtonPress.bind(this)} style={styleText.buttonStyle} underlayColor="white">
                    ...
                    <View style={styleText.bottomContainer}>
                        <Text style={styleText.bottomMessage}>Already a member?</Text>
                        <TouchableHighlight onPress={this.onSignInClicked.bind(this)} underlayColor="white">
